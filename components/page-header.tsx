...
/**
 * The "back to the site" link, title and mascot repeated (previously
 * copy-pasted with small drifts — "Back to the site" vs "Back to the menu",
 * some pages skipping the description) across every secondary public page.
 *
