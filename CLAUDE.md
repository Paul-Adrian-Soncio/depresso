...
[data-period="afternoon"] {
  --ground: #EFE9DF;  --surface: #F8F3EA;  --surface-2: #E7DFD1;
  --ink: #2A2420;     --ink-2: #5C5346;    --ink-3: #655C4E;
  --accent: #B06813;  --accent-text: #96590F;  --on-accent: #FBF6EF;
  --cool: #5C7C88;    --line: #E0D6C4;     --line-strong: #C7B99F;
  --ok: #5C7C4E;
}
[data-period="dusk"] {
